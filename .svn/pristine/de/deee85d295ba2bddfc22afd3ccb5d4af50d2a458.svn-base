// -----------------------------------------------------------------------
// <copyright file="PasswordUpdatedPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the PasswordUpdatedPage class
	/// </summary>
	public partial class PasswordUpdatedPage 
	{	
		public PasswordUpdatedPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets PasswordUpdatedHeader Label
		/// </summary> 
		private Label PasswordUpdatedHeader
		{
			get { return new Label("PasswordUpdatedHeader", "//span[text()='Password Updated']", 3, false); }
		}
