// -----------------------------------------------------------------------
// <copyright file="PollsAndAwardsPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the PollsAndAwardsPage class
	/// </summary>
	public partial class PollsAndAwardsPage 
	{	
		public PollsAndAwardsPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets PollsAndAwards Label
		/// </summary> 
		private Label PollsAndAwards
		{
			get { return new Label("PollsAndAwards", "//span[contains(text(), 'Polls and Awards')]", 0, false); }
		}
