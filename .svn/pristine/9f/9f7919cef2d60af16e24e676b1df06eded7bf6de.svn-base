// -----------------------------------------------------------------------
// <copyright file="CookiesPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the CookiesPage class
	/// </summary>
	public partial class CookiesPage 
	{	
		public CookiesPage(bool optional=false)
		{
		...
		{
			get { return new Label("Cookies", "//h2[contains(text(), 'COOKIES')]", 0, false); }
		}
