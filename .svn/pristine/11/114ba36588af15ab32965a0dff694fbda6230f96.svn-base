// -----------------------------------------------------------------------
// <copyright file="DevelopmentPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the DevelopmentPage class
	/// </summary>
	public partial class DevelopmentPage 
	{	
		public DevelopmentPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets Development Label
		/// </summary> 
		private Label Development
		{
			get { return new Label("Development", "//h1[contains(text(), 'Development')]", 0, false); }
		}
