// -----------------------------------------------------------------------
// <copyright file="FeaturesPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the FeaturesPage class
	/// </summary>
	public partial class FeaturesPage 
	{	
		public FeaturesPage(bool optional=false)
		{
		...
		{
			get { return new Label("Features", "//h1[contains(text(), 'Features')]", 0, false); }
		}
