...
namespace PageObjects.PageObjects
{
	...
	{	
		...
		{
			get { return new Label("PaymentFrame", "//iframe[contains(@id,'CyberSource')]", 30, false); }
		}
		...
		{
			get { return new Textbox("CreditCardNumber", "//input[@id='card_number']", 30, false); }
		}
		...
		private Textbox CVN
		{
			get { return new Textbox("CVN", "//input[@id='card_cvn']", 30, false); }
		}
		...
		{
			get { return new Dropdown("TypeCard", "//select[@id='card_type']", 30, false); }
		}
		...
		private Button Buy
		{
			get { return new Button("Buy", "//input[@value='Pay']", 30, false); }
		}
