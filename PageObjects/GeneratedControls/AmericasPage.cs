// -----------------------------------------------------------------------
// <copyright file="AmericasPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the AmericasPage class
	/// </summary>
	public partial class AmericasPage 
	{	
		public AmericasPage(bool optional=false)
		{
		...
		/// Gets Americas Label
		/// </summary> 
		private Label Americas
		{
			get { return new Label("Americas", "//h1[contains(text(), 'Americas')]", 0, false); }
		}
