// -----------------------------------------------------------------------
// <copyright file="CommentAndOpinionPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the CommentAndOpinionPage class
	/// </summary>
	public partial class CommentAndOpinionPage 
	{	
		public CommentAndOpinionPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets CommentAndOpinion Label
		/// </summary> 
		private Label CommentAndOpinion
		{
			get { return new Label("CommentAndOpinion", "//h1[contains(text(), 'Comment & Opinion')]", 0, false); }
		}
