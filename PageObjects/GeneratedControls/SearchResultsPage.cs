// -----------------------------------------------------------------------
// <copyright file="SearchResultsPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	{	
		public SearchResultsPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets SearchResultsHeader Label
		/// </summary> 
		private Label SearchResultsHeader
		{
			get { return new Label("SearchResultsHeader", "//h1[contains(text(),'SEARCH RESULTS')]", 0, false); }
		}
