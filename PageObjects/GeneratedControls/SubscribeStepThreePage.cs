...
namespace PageObjects.PageObjects
{
	...
	{	
		...
		{
			get { return new Textbox("AddressFirstLineBillingAddress", "//input[contains(@id, 'PurchaseContainer_PaymentAddress1')]", 0, false); }
		}
		...
		{
			get { return new Textbox("AddressSecondLineBillingAddress", "//input[contains(@id, 'PurchaseContainer_PaymentAddress2')]", 0, false); }
		}
		...
		{
			get { return new Textbox("AddressThirdLineBillingAddress", "//input[contains(@id, 'PurchaseContainer_PaymentAddress3')]", 0, false); }
		}
		...
		{
			get { return new Textbox("PostCodeBillingAddress", "//input[contains(@id,'PurchaseContainer_PaymentPostCode')]", 0, false); }
		}
		...
		{
			get { return new Dropdown("CountryBillingAddress", "//select[contains(@id,'PurchaseContainer_PaymentCountry')]", 0, false); }
		}
		...
		{
			get { return new Dropdown("Country", "//div[contains(@id,'PurchaseContainer_divDelivryAddres')]//select[contains(@id,'Country')]", 0, false); }
		}
