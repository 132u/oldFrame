// -----------------------------------------------------------------------
// <copyright file="SponsoredReportsPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the SponsoredReportsPage class
	/// </summary>
	public partial class SponsoredReportsPage 
	{	
		public SponsoredReportsPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets SponsoredReports Label
		/// </summary> 
		private Label SponsoredReports
		{
			get { return new Label("SponsoredReports", "//h1[contains(text(), 'Sponsored Reports')]", 0, false); }
		}
