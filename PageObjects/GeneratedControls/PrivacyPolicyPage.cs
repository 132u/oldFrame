// -----------------------------------------------------------------------
// <copyright file="PrivacyPolicyPage.cs" company="Euromoney">
...
namespace PageObjects.PageObjects
{
	...
	/// <summary> 
	/// Initializes a new instance of the PrivacyPolicyPage class
	/// </summary>
	public partial class PrivacyPolicyPage 
	{	
		public PrivacyPolicyPage(bool optional=false)
		{
		...
		/// <summary>
		/// Gets PrivacyPolicy Label
		/// </summary> 
		private Label PrivacyPolicy
		{
			get { return new Label("PrivacyPolicy", "//span[text() = 'Privacy']", 0, false); }
		}
